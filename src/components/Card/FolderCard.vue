...
<template>
  <div class="project">
    <a-card hoverable style="cursor: auto">
      <!-- 上半部分 -->
      <div class="card-top">
...
<!--        <span class="icon"><FolderIcon /></span>-->
        <div class="card-top-text">
          <h1 class="card-title">{{ props.alias ? props.alias : props.name }}</h1>
          <p style="color: #666;">{{ props.alias ? props.name : props.alias }}</p>
...
.icon {
  ...
  font-size: 5em;
  /* 上 右 下 左*/
  margin: -0.4em -0.1em -0.15em -0.18em;
}
</style>
